...
const $dacea6f50a09eb13$export$6b962911844bfb1e = (function () {
  ...
  \*/ $dacea6f50a09eb13$export$6b962911844bfb1e = function (name, scope) {
      var oldstop = stop,
        ...
        listeners = $dacea6f50a09eb13$export$6b962911844bfb1e.listeners(name),
        z = 0,
        l,
        indexed = [],
        queue = {},
  ...
  \*/ $dacea6f50a09eb13$export$6b962911844bfb1e.on = function (name1, f) {
    ...
    var names1 = isArray(name1)
      ? isArray(name1[0])
        ? name1
        : [name1]
      : Str(name1).split(comaseparator)
    for (var i1 = 0, ii1 = names1.length; i1 < ii1; i1++)
      (function (name) {
  ...
  \*/ $dacea6f50a09eb13$export$6b962911844bfb1e.f = function (event) {
    ...
    return function () {
      $dacea6f50a09eb13$export$6b962911844bfb1e.apply(
        null,
   ...
   **
   * See @eve.off
  \*/ $dacea6f50a09eb13$export$6b962911844bfb1e.off =
    $dacea6f50a09eb13$export$6b962911844bfb1e.unbind = function (name, f) {
      if (!name) {
        $dacea6f50a09eb13$export$6b962911844bfb1e._events = events = {
          n: {},
        }
      ...
      if (names.length > 1) {
        for (var i = 0, ii = names.length; i < ii; i++)
          $dacea6f50a09eb13$export$6b962911844bfb1e.off(names[i], f)
        return
      }
...
const $c453c098b23bc46d$export$db202ddc8be9136 = (function () {
  ...
  \ */ function $c453c098b23bc46d$export$db202ddc8be9136(first) {
    if ($c453c098b23bc46d$export$db202ddc8be9136.is(first, 'function'))
      return loaded1
        ? first()
        : $dacea6f50a09eb13$export$6b962911844bfb1e.on('raphael.DOMload', first)
    if ($c453c098b23bc46d$export$db202ddc8be9136.is(first, array1))
      return $c453c098b23bc46d$export$db202ddc8be9136._engine.create[apply](
        $c453c098b23bc46d$export$db202ddc8be9136,
        first.splice(
          0,
          3 + $c453c098b23bc46d$export$db202ddc8be9136.is(first[0], nu)
        )
      ).add(first)
    const args = Array.prototype.slice.call(arguments, 0)
    if (
      $c453c098b23bc46d$export$db202ddc8be9136.is(
        args[args.length - 1],
        'function'
      )
    ) {
      ...
      return loaded1
        ? f.call(
            $c453c098b23bc46d$export$db202ddc8be9136._engine.create[apply](
              $c453c098b23bc46d$export$db202ddc8be9136,
              args
            )
          )
        : $dacea6f50a09eb13$export$6b962911844bfb1e.on(
            'raphael.DOMload',
            () => {
              f.call(
                $c453c098b23bc46d$export$db202ddc8be9136._engine.create[apply](
  ...
  $c453c098b23bc46d$export$db202ddc8be9136.eve =
    $dacea6f50a09eb13$export$6b962911844bfb1e
  let loaded1
  const separator = /[, ]+/
  const elements = {
    circle: 1,
  ...
  const concat = 'concat'
  const supportsTouch =
    'ontouchstart' in g1.win ||
    (g1.win.DocumentTouch && g1.doc instanceof DocumentTouch) // taken from Modernizr touch test
  const E = ''
  const S1 = ' '
  const Str = String
  const split = 'split'
  ...
  const paper1 = {}
  const push = 'push'
  const ISURL = ($c453c098b23bc46d$export$db202ddc8be9136._ISURL =
    /^url\(['"]?(.+?)['"]?\)$/i)
  const colourRegExp =
  ...
  const availableAttrs =
    ($c453c098b23bc46d$export$db202ddc8be9136._availableAttrs = {
      'arrow-end': 'none',
      'arrow-start': 'none',
      blur: 0,
  ...
  const availableAnimAttrs =
    ($c453c098b23bc46d$export$db202ddc8be9136._availableAnimAttrs = {
      blur: nu,
      'clip-rect': 'csv',
      cx: nu,
      cy: nu,
  ...
  const radial_gradient =
    ($c453c098b23bc46d$export$db202ddc8be9136._radial_gradient =
  ...
  const rectPath = ($c453c098b23bc46d$export$db202ddc8be9136._rectPath =
    function (x, y, w, h, r) {
      if (r)
        return [
          ['M', x + r, y],
  ...
  /* \
    ...
    \ */ const mapPath = ($c453c098b23bc46d$export$db202ddc8be9136.mapPath =
   ...
   * ensure any namespacing ensures proper context.
   ...
   | paper.mystuff.arrow();
   | paper.mystuff.star();
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.fn =
    paperproto =
    Paper.prototype =
      $c453c098b23bc46d$export$db202ddc8be9136.prototype
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.angle = function (
    x1,
    y1,
    x2,
    y2,
    ...
    return (
      $c453c098b23bc46d$export$db202ddc8be9136.angle(x1, y1, x3, y3) -
      $c453c098b23bc46d$export$db202ddc8be9136.angle(x2, y2, x3, y3)
    )
  }
  /* \
   * Raphael.rad
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.snapTo = function (
    values,
    value,
    tolerance
  ) {
    tolerance = $c453c098b23bc46d$export$db202ddc8be9136.is(tolerance, 'finite')
      ? tolerance
      : 10
  ...
  \ */ const createUUID = ($c453c098b23bc46d$export$db202ddc8be9136.createUUID =
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.setWindow = function (newwin) {
    ...
    if ($c453c098b23bc46d$export$db202ddc8be9136._engine.initWin)
      $c453c098b23bc46d$export$db202ddc8be9136._engine.initWin(g1.win)
  }
  ...
  const prepareRGB = function (r, g, b) {
    if (
      g == null &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(r, 'object') &&
      'r' in r &&
      'g' in r &&
      'b' in r
    ) {
  ...
  const packageRGB = function (r, g, b, o) {
    ...
    $c453c098b23bc46d$export$db202ddc8be9136.is(o, 'finite') &&
      (rgb.opacity = o)
    return rgb
  }
  /* \
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.color = function (clr) {
    let rgb
    if (
      $c453c098b23bc46d$export$db202ddc8be9136.is(clr, 'object') &&
      'h' in clr &&
      's' in clr &&
      'b' in clr
    ) {
      ...
      if ($c453c098b23bc46d$export$db202ddc8be9136.is(clr, 'string'))
        clr = $c453c098b23bc46d$export$db202ddc8be9136.getRGB(clr)
      if (
        $c453c098b23bc46d$export$db202ddc8be9136.is(clr, 'object') &&
        'r' in clr &&
        'g' in clr &&
   ...
   * Converts HSB values to RGB object.
   ...
   o     hex (string) color in HTML/CSS format: #••••••
   o }
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.hsb2rgb = function (
    h,
    s,
    v,
    o
    ...
    h = ~~h
    $c453c098b23bc46d$export$db202ddc8be9136 += [C, X, 0, 0, X, C][h]
    G += [X, C, C, X, 0, 0][h]
    B += [0, 0, X, C, C, X][h]
   ...
   * Converts HSL values to RGB object.
   ...
   o     hex (string) color in HTML/CSS format: #••••••
   o }
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.hsl2rgb = function (
    h,
    s,
    l,
    o
  ...
  const preload = ($c453c098b23bc46d$export$db202ddc8be9136._preload =
    function (src, f) {
   ...
   * Parses colour string as RGB object
   ...
   o     error (boolean) true if string can’t be parsed
   o }
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.getRGB = cacher(
    'getRGB',
    (colour) => {
      ...
      if (rgb) {
        ...
        if (rgb[5]) {
          ...
          rgb[1].toLowerCase().slice(0, 4) == 'hsba' &&
            (opacity = toFloat(values[3]))
          values[3] && values[3].slice(-1) == '%' && (opacity /= 100)
          return $c453c098b23bc46d$export$db202ddc8be9136.hsb2rgb(
            red,
            green,
            blue,
            opacity
        ...
        if (rgb[6]) {
          ...
          rgb[1].toLowerCase().slice(0, 4) == 'hsla' &&
            (opacity = toFloat(values[3]))
          values[3] && values[3].slice(-1) == '%' && (opacity /= 100)
          return $c453c098b23bc46d$export$db202ddc8be9136.hsl2rgb(
            red,
            green,
            blue,
            opacity
        ...
        rgb.hex = `#${(16777216 | blue | (green << 8) | (red << 16))
          .toString(16)
          .slice(1)}`
        $c453c098b23bc46d$export$db202ddc8be9136.is(opacity, 'finite') &&
          (rgb.opacity = opacity)
        return rgb
      }
      return {
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.hsb = cacher(
    'hsb',
    (h, s, b) => $c453c098b23bc46d$export$db202ddc8be9136.hsb2rgb(h, s, b).hex
  )
  /* \
   * Raphael.hsl
   [ method ]
   ...
   * Converts HSL values to hex representation of the colour.
   ...
   - l (number) luminosity
   = (string) hex representation of the colour.
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.hsl = cacher(
    'hsl',
    (h, s, l) => $c453c098b23bc46d$export$db202ddc8be9136.hsl2rgb(h, s, l).hex
  )
  /* \
   * Raphael.rgb
   [ method ]
   ...
   * Converts RGB values to hex representation of the colour.
   ...
   - b (number) blue
   = (string) hex representation of the colour.
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.rgb = cacher(
    'rgb',
    (r, g, b) => {
      function round(x) {
        return (x + 0.5) | 0
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.parsePathString = function (
    pathString
  ) {
    ...
    let data = []
    if (
      $c453c098b23bc46d$export$db202ddc8be9136.is(pathString, array1) &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(pathString[0], array1)
    )
      // rough assumption
      data = pathClone(pathString)
    if (!data.length)
      Str(pathString).replace(pathCommand, (a, b1, c) => {
        const params = []
        ...
        if (name == 'm' && params.length > 2) {
          data.push([b1][concat](params.splice(0, 2)))
          name = 'l'
          b1 = b1 == 'm' ? 'l' : 'L'
        }
        if (name == 'r') data.push([b1][concat](params))
        else
          while (params.length >= paramCounts[name]) {
            data.push([b1][concat](params.splice(0, paramCounts[name])))
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.parseTransformString = cacher(
    ...
    (TString) => {
      ...
      let data = []
      if (
        $c453c098b23bc46d$export$db202ddc8be9136.is(TString, array1) &&
        $c453c098b23bc46d$export$db202ddc8be9136.is(TString[0], array1)
      )
        // rough assumption
        data = pathClone(TString)
      if (!data.length)
        Str(TString).replace(tCommand, (a, b2, c) => {
          const params = []
          const name = lowerCase.call(b2)
          c.replace(pathValues, (a, b) => {
            b && params.push(+b)
          })
          data.push([b2][concat](params))
        })
      data.toString = $c453c098b23bc46d$export$db202ddc8be9136._path2string
      return data
    }
   ...
   * Find dot coordinates on the given cubic bezier curve at the given t.
   ...
   o }
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.findDotsAtSegment = function (
    p1x,
    p1y,
    c1x,
    c1y,
   ...
   * or
   ...
   o     }
   o }
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.bezierBBox = function (
    p1x,
    p1y,
    c1x,
    c1y,
    ...
    if (!$c453c098b23bc46d$export$db202ddc8be9136.is(p1x, 'array'))
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.isPointInsideBBox = function (
    bbox,
    x,
    y
  ) {
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.isBBoxIntersect = function (
    bbox1,
    bbox2
  ) {
  ...
  function interHelper(bez1, bez2, justCount) {
    ...
    if (!$c453c098b23bc46d$export$db202ddc8be9136.isBBoxIntersect(bbox1, bbox2))
      return justCount ? 0 : []
    ...
    for (var i = 0; i < n1 + 1; i++) {
      var p = $c453c098b23bc46d$export$db202ddc8be9136.findDotsAtSegment.apply(
        $c453c098b23bc46d$export$db202ddc8be9136,
        bez1.concat(i / n1)
      )
      dots1.push({
    ...
    for (i = 0; i < n2 + 1; i++) {
      p = $c453c098b23bc46d$export$db202ddc8be9136.findDotsAtSegment.apply(
        $c453c098b23bc46d$export$db202ddc8be9136,
        bez2.concat(i / n2)
      )
      dots2.push({
   ...
   * Finds intersections of two paths
   ...
   o     }
   o ]
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.pathIntersection = function (
    path1,
    path2
  ) {
    return interPathHelper(path1, path2)
  }
  $c453c098b23bc46d$export$db202ddc8be9136.pathIntersectionNumber = function (
    path1,
    path2
  ) {
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.isPointInsidePath = function (
    path,
    x,
    y
  ) {
    ...
    return (
      $c453c098b23bc46d$export$db202ddc8be9136.isPointInsideBBox(bbox, x, y) &&
      interPathHelper(
        path,
        [
          ['M', x, y],
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._removedFactory = function (
    methodname
  ) {
    return function () {
      $dacea6f50a09eb13$export$6b962911844bfb1e(
  ...
  \ */ const pathDimensions =
    ($c453c098b23bc46d$export$db202ddc8be9136.pathBBox = function (path) {
  ...
  const pathToRelative =
    ($c453c098b23bc46d$export$db202ddc8be9136._pathToRelative = function (
      pathArray
    ) {
      const pth = paths(pathArray)
      if (pth.rel) return pathClone(pth.rel)
      if (
        !$c453c098b23bc46d$export$db202ddc8be9136.is(pathArray, array1) ||
        !$c453c098b23bc46d$export$db202ddc8be9136.is(
        ...
        // rough assumption
        pathArray =
          $c453c098b23bc46d$export$db202ddc8be9136.parsePathString(pathArray)
      const res = []
      let x = 0
      let y = 0
      let mx = 0
  ...
  const pathToAbsolute =
    ($c453c098b23bc46d$export$db202ddc8be9136._pathToAbsolute = function (
      pathArray
    ) {
      // return pathArray;
      const pth = paths(pathArray)
  ...
  var a2c = function (
    ...
    for (let i = 0, ii = res.length; i < ii; i++)
      newres[i] =
        i % 2
          ? rotate(res[i - 1], res[i], rad1).y
          : rotate(res[i], res[i + 1], rad1).x
    return newres
  }
  ...
  var path2curve = ($c453c098b23bc46d$export$db202ddc8be9136._path2curve =
    cacher(
      'path2curve',
      (path1, path21) => {
        ...
        for (
          var i2 = 0, ii = mmax(p.length, (p2 && p2.length) || 0);
          i2 < ii;
          i2++
        ) {
          ...
          if (pcoms1[i2] != 'A' && pfirst == 'C')
            pcoms1[i2] = 'C' // A is the only command
  ...
  const parseDots = ($c453c098b23bc46d$export$db202ddc8be9136._parseDots =
    cacher('parseDots', (gradient) => {
      const dots = []
  ...
  const tear = ($c453c098b23bc46d$export$db202ddc8be9136._tear = function (
    el,
    paper
  ) {
  ...
  const tofront = ($c453c098b23bc46d$export$db202ddc8be9136._tofront =
    function (el, paper) {
  ...
  const toback = ($c453c098b23bc46d$export$db202ddc8be9136._toback = function (
    el,
    paper
  ) {
  ...
  const insertafter = ($c453c098b23bc46d$export$db202ddc8be9136._insertafter =
  ...
  const insertbefore = ($c453c098b23bc46d$export$db202ddc8be9136._insertbefore =
    function (el, el2, paper) {
      tear(el, paper)
  ...
  /* \
     ...
     * Returns matrix of transformations applied to a given path
     ...
     = (object) @Matrix
    \ */ const toMatrix = ($c453c098b23bc46d$export$db202ddc8be9136.toMatrix =
  ...
  /* \
     ...
     * Returns path transformed by a given transformation
     ...
     = (string) path
    \ */ const transformPath =
    ($c453c098b23bc46d$export$db202ddc8be9136.transformPath = function (
      path,
      transform
    ) {
  ...
  var extractTransform =
    ($c453c098b23bc46d$export$db202ddc8be9136._extractTransform = function (
      el,
      tstr
    ) {
      ...
      const tdata =
        $c453c098b23bc46d$export$db202ddc8be9136.parseTransformString(tstr)
      let deg = 0
      let dx = 0
      let dy = 0
      let sx = 1
  ...
  const getEmpty = function (item) {
    ...
    switch (l.toLowerCase()) {
      ...
      case 's':
        ...
        if (item.length == 3) return [l, 1, 1]
        return [l, 1]
    }
  }
  const equaliseTransform =
    ($c453c098b23bc46d$export$db202ddc8be9136._equaliseTransform = function (
      t1,
      t2
    ) {
      t2 = Str(t2).replace(/\.{3}|\u2026/g, t1)
      t1 =
        $c453c098b23bc46d$export$db202ddc8be9136.parseTransformString(t1) || []
      t2 =
        $c453c098b23bc46d$export$db202ddc8be9136.parseTransformString(t2) || []
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._getContainer = function (
    x,
    y,
    w,
    h
    ...
    let container
    container =
      h == null && !$c453c098b23bc46d$export$db202ddc8be9136.is(x, 'object')
        ? g1.doc.getElementById(x)
        : x
   ...
   * Returns matrix based on given parameters.
   ...
   - f (number)
   = (object) @Matrix
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.matrix = function (
    a,
    b,
    c,
    d,
  ...
  ;(function (matrixproto) {
    ...
    matrixproto.toString = function () {
      return $c453c098b23bc46d$export$db202ddc8be9136.svg
        ? `matrix(${[
            this.get(0),
            this.get(1),
            this.get(2),
    ...
    \ */ matrixproto.split = function () {
      ...
      const cos = row[1][1]
      if (cos < 0) {
        out.rotate = $c453c098b23bc46d$export$db202ddc8be9136.deg(
          math.acos(cos)
        )
  ...
  const addEvent = (function () {
    ...
    if (g1.doc.attachEvent)
      return function (obj, type, fn, element) {
        const f = function (e) {
          e = e || g1.win.event
          const scrollY =
            g1.doc.documentElement.scrollTop || g1.doc.body.scrollTop
          const scrollX =
            g1.doc.documentElement.scrollLeft || g1.doc.body.scrollLeft
   ...
   * Removes event handler for touchcancel for the element.
   ...
   - handler (function) #optional handler for the event
   = (object) @Element
  \ */ for (let i1 = events1.length; i1--; )
    (function (eventName) {
      $c453c098b23bc46d$export$db202ddc8be9136[eventName] = elproto[eventName] =
        function (fn, scope) {
      ...
      $c453c098b23bc46d$export$db202ddc8be9136[`un${eventName}`] = elproto[
        `un${eventName}`
      ] = function (fn) {
        ...
        while (l--)
          if (
            ...
            ($c453c098b23bc46d$export$db202ddc8be9136.is(fn, 'undefined') ||
              events[l].f == fn)
          ) {
            events[l].unbind()
            events.splice(l, 1)
  ...
  \ */ elproto.onDragOver = function (f) {
    f
      ...
      : $dacea6f50a09eb13$export$6b962911844bfb1e.unbind(
          `raphael.drag.over.${this.id}`
        )
  }
  /* \
  ...
  \ */ paperproto.circle = function (x, y, r) {
    const out = $c453c098b23bc46d$export$db202ddc8be9136._engine.circle(
      this,
      x || 0,
      y || 0,
      r || 0
  ...
  \ */ paperproto.rect = function (x, y, w, h, r) {
    const out = $c453c098b23bc46d$export$db202ddc8be9136._engine.rect(
      this,
      x || 0,
      y || 0,
      w || 0,
  ...
  \ */ paperproto.ellipse = function (x, y, rx, ry) {
    const out = $c453c098b23bc46d$export$db202ddc8be9136._engine.ellipse(
      this,
      x || 0,
      y || 0,
      rx || 0,
  ...
  \ */ paperproto.path = function (pathString) {
    pathString &&
      !$c453c098b23bc46d$export$db202ddc8be9136.is(pathString, string1) &&
      !$c453c098b23bc46d$export$db202ddc8be9136.is(pathString[0], array1) &&
      (pathString += E)
    const out = $c453c098b23bc46d$export$db202ddc8be9136._engine.path(
      $c453c098b23bc46d$export$db202ddc8be9136.format[apply](
        $c453c098b23bc46d$export$db202ddc8be9136,
        arguments
      ),
      this
  ...
  \ */ paperproto.image = function (src, x, y, w, h) {
    const out = $c453c098b23bc46d$export$db202ddc8be9136._engine.image(
      this,
      src || 'about:blank',
      x || 0,
      y || 0,
  ...
  \ */ paperproto.text = function (x, y, text) {
    const out = $c453c098b23bc46d$export$db202ddc8be9136._engine.text(
      this,
      x || 0,
      y || 0,
      Str(text)
  ...
  \ */ paperproto.set = function (itemsArray) {
    !$c453c098b23bc46d$export$db202ddc8be9136.is(itemsArray, 'array') &&
  ...
  \ */ paperproto.setSize = function (width, height) {
    return $c453c098b23bc46d$export$db202ddc8be9136._engine.setSize.call(
      this,
      width,
      height
    )
  ...
  \ */ paperproto.setViewBox = function (x, y, w, h, fit) {
    return $c453c098b23bc46d$export$db202ddc8be9136._engine.setViewBox.call(
      this,
      x,
      y,
      w,
  ...
  const getOffset = function (elem) {
    ...
    const top =
      box.top +
      (g1.win.pageYOffset || docElem.scrollTop || body.scrollTop) -
      clientTop
    const left =
      box.left +
      (g1.win.pageXOffset || docElem.scrollLeft || body.scrollLeft) -
      clientLeft
    return {
      y: top,
      x: left,
   ...
   **
   ...
   \ */ paperproto.getElementsByBBox = function (bbox) {
    ...
    this.forEach((el) => {
      if (
        $c453c098b23bc46d$export$db202ddc8be9136.isBBoxIntersect(
          el.getBBox(),
          bbox
        )
      )
  ...
  \ */ elproto.isPointInside = function (x, y) {
    ...
    if (this.attr('transform') && this.attr('transform').length)
      rp = $c453c098b23bc46d$export$db202ddc8be9136.transformPath(
        rp,
        this.attr('transform')
      )
  ...
  const getPointAtSegmentLength = function (
    ...
    return $c453c098b23bc46d$export$db202ddc8be9136.findDotsAtSegment(
      p1x,
      p1y,
      c1x,
      c1y,
  ...
  const getLengthFactory = function (istotal, subpath) {
    return function (path, length, onlystart) {
      ...
      point = istotal
        ...
        : subpath
        ? subpaths
        : $c453c098b23bc46d$export$db202ddc8be9136.findDotsAtSegment(
            x,
            y,
            p[0],
            p[1],
   ...
   **
   ...
   o }
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.getPointAtLength =
    getPointAtLength
  /* \
   * Raphael.getSubpath
   [ method ]
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.getSubpath = function (
    path,
    from,
    to
  ) {
    ...
    for (; l < animationElements.length; l++) {
      ...
      if (time < ms) {
        ...
        ;(function (f, el, a) {
          setTimeout(() => {
            $dacea6f50a09eb13$export$6b962911844bfb1e(
              `raphael.anim.frame.${el.id}`,
              el,
              a
            )
            $dacea6f50a09eb13$export$6b962911844bfb1e(
              `raphael.anim.finish.${el.id}`,
              el,
              a
            )
            $c453c098b23bc46d$export$db202ddc8be9136.is(f, 'function') &&
              f.call(el)
          })
  ...
  \ */ elproto.animateWith = function (el, anim, params, ms, easing, callback) {
    ...
    const a =
      params instanceof Animation
        ? params
        : $c453c098b23bc46d$export$db202ddc8be9136.animation(
            params,
            ms,
            easing,
            callback
  ...
  function runAnimation(anim, element, percent, status, totalOrigin, times) {
    ...
    if (!isInAnim) {
          ...
          if (
            ...
            switch (availableAnimAttrs[attr]) {
              case nu:
                ...
                break
              case 'colour':
                from[attr] = $c453c098b23bc46d$export$db202ddc8be9136.getRGB(
                  from[attr]
                )
                var toColour = $c453c098b23bc46d$export$db202ddc8be9136.getRGB(
                  to[attr]
                )
                diff[attr] = {
      ...
      let easyeasy =
        $c453c098b23bc46d$export$db202ddc8be9136.easing_formulas[easing]
      if (!easyeasy) {
   ...
   **
   = (object) @Animation
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.animation = function (
    params,
    ms,
    easing,
    callback
    ...
    if (
      $c453c098b23bc46d$export$db202ddc8be9136.is(easing, 'function') ||
      !easing
    ) {
  ...
  setproto.attr = function (name, value) {
    if (
      name &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(name, array1) &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(name[0], 'object')
    )
      for (let j = 0, jj = name.length; j < jj; j++) this.items[j].attr(name[j])
    else
      for (let i = 0, ii = this.items.length; i < ii; i++)
  ...
  setproto.animate = function (params, ms, easing, callback) {
    ...
    easing = $c453c098b23bc46d$export$db202ddc8be9136.is(easing, string1)
      ? easing
      : collector
    const anim = $c453c098b23bc46d$export$db202ddc8be9136.animation(
      params,
      ms,
      easing,
      collector
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.registerFont = function (font) {
    ...
    for (const prop in font.face)
      if (font.face[has](prop)) fontcopy.face[prop] = font.face[prop]
        ...
        if (font.glyphs[has](glyph)) {
          ...
          if (path.k) {
            for (const k in path.k)
              if (path[has](k)) fontcopy.glyphs[glyph].k[k] = path.k[k]
          }
        }
    }
    return font
  ...
  \ */ paperproto.getFont = function (family, weight, style, stretch) {
    ...
    if (!font) {
      ...
      for (const fontName in $c453c098b23bc46d$export$db202ddc8be9136.fonts)
        if ($c453c098b23bc46d$export$db202ddc8be9136.fonts[has](fontName)) {
  ...
  \ */ paperproto.print = function (
    ...
    let path = E
    let scale
    $c453c098b23bc46d$export$db202ddc8be9136.is(font, 'string') &&
    ...
    if (font) {
      ...
      for (let i = 0, ii = letters.length; i < ii; i++) {
        ...
        if (curr && curr.d)
          path += $c453c098b23bc46d$export$db202ddc8be9136.transformPath(
            curr.d,
            [
              't',
              shift * scale,
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.format = function (
    token,
    params
  ) {
    const args = $c453c098b23bc46d$export$db202ddc8be9136.is(params, array1)
      ...
      : arguments
    token &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(token, string1) &&
      args.length - 1 &&
  ...
  ;(function (doc, loaded, f) {
    ...
    function isLoaded() {
      ;/in/.test(doc && doc.readyState)
        ? setTimeout(isLoaded, 9)
        : $c453c098b23bc46d$export$db202ddc8be9136.eve('raphael.DOMload')
    }
    isLoaded()
...
const $65a92514e25c9f85$export$508faed300ccdfb = (function () {
  ...
  var $ = function (el, attr) {
    if (attr) {
      ...
      el = $c453c098b23bc46d$export$db202ddc8be9136._g.doc.createElementNS(
  ...
  const addArrow = function (o, value, isEnd) {
    if (o.type == 'path') {
      ...
      if (type != 'none') {
        ...
        if (
          !$c453c098b23bc46d$export$db202ddc8be9136._g.doc.getElementById(
            pathId
          ) ||
          ($c453c098b23bc46d$export$db202ddc8be9136._g.doc.getElementById(
            pathId
        ...
        if (isEnd) {
          ...
          to =
            $c453c098b23bc46d$export$db202ddc8be9136.getTotalLength(
              attrs.path
            ) -
            delta * stroke
        } else {
        ...
        if (to || from)
          attr.d = $c453c098b23bc46d$export$db202ddc8be9136.getSubpath(
            attrs.path,
            from,
            to
          )
        ...
        o._.arrows[`${se}Path`] &&
          $(node, {
            d: $c453c098b23bc46d$export$db202ddc8be9136.getSubpath(
              attrs.path,
              from,
              to
            ),
      ...
      for (attr in markerCounter)
        if (markerCounter[has](attr) && !markerCounter[attr]) {
          const item =
            $c453c098b23bc46d$export$db202ddc8be9136._g.doc.getElementById(attr)
  ...
  const setFillAndStroke = function (o, params) {
    ...
    for (let att in params)
      if (params[has](att)) {
        if (!$c453c098b23bc46d$export$db202ddc8be9136._availableAttrs[has](att))
          continue
        ...
        switch (att) {
          ...
          case 'title':
            ...
            if (title.length && (title = title[0]))
              ...
              title = $('title')
              const val =
                $c453c098b23bc46d$export$db202ddc8be9136._g.doc.createTextNode(
                  value
                )
          ...
          case 'fill':
            ...
            var isURL = Str(value).match(
              $c453c098b23bc46d$export$db202ddc8be9136._ISURL
            )
            if (isURL) {
              if (value.indexOf('(#') > -1)
                // internal reference
                ...
                el.appendChild(ig)
                ;(function (el) {
                  $c453c098b23bc46d$export$db202ddc8be9136._preload(
                    isURL[1],
                    function () {
  ...
  var tuneText = function (el, params) {
    ...
    const fontSize = node.firstChild
      ? toInt(
          $c453c098b23bc46d$export$db202ddc8be9136._g.doc.defaultView
    ...
    dif &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(dif, 'finite') &&
      $(tspans[0], {
        dy: dif,
      })
  }
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.path = function (
    pathString,
    SVG
  ) {
    const el = $('path')
    ...
    for (const i in this)
      this[i] =
        typeof this[i] === 'function'
          ? $c453c098b23bc46d$export$db202ddc8be9136._removedFactory(i)
          : null
    this.removed = true
  }
  ...
  \ */ elproto.attr = function (name, value) {
    ...
    if (
      value == null &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(name, 'string')
    ) {
      ...
      for (var i = 0, ii = names.length; i < ii; i++) {
        ...
        if (name in this.attrs) out[name] = this.attrs[name]
          ...
          out[name] =
            $c453c098b23bc46d$export$db202ddc8be9136._availableAttrs[name]
      }
      return ii - 1 ? out : out[names[0]]
    }
    if (
      value == null &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(name, 'array')
    ) {
      out = {}
    ...
    if (value != null) {
      ...
      name != null &&
      $c453c098b23bc46d$export$db202ddc8be9136.is(name, 'object')
    )
      params = name
    ...
    for (key in this.paper.customAttributes)
      if (
        ...
        for (const subkey in par)
          if (par[has](subkey)) params[subkey] = par[subkey]
      }
  ...
  \ */ elproto.toFront = function () {
    ...
    svg.top != this &&
      $c453c098b23bc46d$export$db202ddc8be9136._tofront(this, svg)
    return this
  }
  /* \
   * Element.toBack
  ...
  \ */ elproto.insertAfter = function (element) {
    ...
    $c453c098b23bc46d$export$db202ddc8be9136._insertafter(
      this,
      element,
      this.paper
    )
  ...
  \ */ elproto.insertBefore = function (element) {
    ...
    $c453c098b23bc46d$export$db202ddc8be9136._insertbefore(
      this,
      element,
      this.paper
    )
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.circle = function (
    svg,
    x,
    y,
    r
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.rect = function (
    svg,
    x,
    y,
    w,
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.g = function (svg) {
    ...
    const elements = ['circle', 'rect', 'ellipse', 'image', 'text', 'g', 'path']
    elements.forEach((element) => {
      res[element] = function () {
        const args = [res]
        for (let i = 0; i < arguments.length; i++) args.push(arguments[i])
        const out = $c453c098b23bc46d$export$db202ddc8be9136._engine[
          element
        ].apply(this, args)
        return out
      }
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.def = function (def) {
    ...
    */ const id =
      def.id ||
      `raphael-def-${$c453c098b23bc46d$export$db202ddc8be9136.createUUID()}`
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.ellipse = function (
    svg,
    x,
    y,
    rx,
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.image = function (
    svg,
    src,
    x,
    y,
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.text = function (
    svg,
    x,
    y,
    text
    ...
    res.attrs = {
      ...
      text: text,
      'font-family':
        $c453c098b23bc46d$export$db202ddc8be9136._availableAttrs['font-family'],
      'font-size':
        $c453c098b23bc46d$export$db202ddc8be9136._availableAttrs['font-size'],
      stroke: 'none',
      fill: '#000',
    }
    res.type = 'text'
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.setSize = function (
    width,
    height
  ) {
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.create = function () {
    const con = $c453c098b23bc46d$export$db202ddc8be9136._getContainer.apply(
      0,
      arguments
    )
  ...
  $c453c098b23bc46d$export$db202ddc8be9136._engine.setViewBox = function (
    x,
    y,
    w,
    h,
  ...
  \ */ $c453c098b23bc46d$export$db202ddc8be9136.prototype.renderfix =
    function () {
...
class $8ab43d25a2892bde$export$2e2bcd8739ae039 {
  ...
  static whiteOrBlack(hex) {
    return $65a92514e25c9f85$export$508faed300ccdfb.rgb2hsb(hex).b < 0.4
      ? '#fff'
      : '#000'
  }
  static _transformPath(original, transform) {
    const rpath = $65a92514e25c9f85$export$508faed300ccdfb
      .transformPath(original, transform)
      .toString()
    return rpath
  }
  static transformPath(_node, _transformation) {
    const _path = $65a92514e25c9f85$export$508faed300ccdfb
      .transformPath(_node.vect.attr('path').toString(), _transformation)
      .toString()
...
function $b3c679d5849c9a45$export$2e2bcd8739ae039(originalPath, transforms) {
  ...
  transformsArray.forEach((transform) => {
    transformedPath = $8ab43d25a2892bde$export$2e2bcd8739ae039
...
class $699224fae48c351a$export$2e2bcd8739ae039 {
  static icons = {
    handle:
      'M26.33,15.836l-3.893-1.545l3.136-7.9c0.28-0.705-0.064-1.505-0.771-1.785c-0.707-0.28-1.506,0.065-1.785,0.771l-3.136,7.9l-4.88-1.937l3.135-7.9c0.281-0.706-0.064-1.506-0.77-1.786c-0.706-0.279-1.506,0.065-1.785,0.771l-3.136,7.9L8.554,8.781l-1.614,4.066l2.15,0.854l-2.537,6.391c-0.61,1.54,0.143,3.283,1.683,3.895l1.626,0.646L8.985,26.84c-0.407,1.025,0.095,2.188,1.122,2.596l0.93,0.369c1.026,0.408,2.188-0.095,2.596-1.121l0.877-2.207l1.858,0.737c1.54,0.611,3.284-0.142,3.896-1.682l2.535-6.391l1.918,0.761L26.33,15.836z',
    editor:
    ...
    sliderHandle:
      'M16,3.5c-4.142,0-7.5,3.358-7.5,7.5c0,4.143,7.5,18.121,7.5,18.121S23.5,15.143,23.5,11C23.5,6.858,20.143,3.5,16,3.5z M16,14.584z',
    speechbubble:
...
const $934e6ef878cbebc0$export$cc3e2d3244e01b7f = function (R) {
  ...
  R.el.tooltip = function (obj, w, h) {
    ...
    if (obj.type === 'text') {
      // text tooltip
      _tt.push(
        this.paper.rect(pos.x, pos.y + h * -1 - 10, w, h, 5).attr({
          fill: '#fff',
        })
      )
      _tt.push(
      ...
      const xpad = w * -1 - 5
      _tt.push(
        this.paper.rect(pos.x + xpad, pos.y + (h / 2) * -1, w, h, 15).attr({
          'stroke-width': 2,
          stroke: '#fff',
          'z-index': 9999,
        })
...
function $bc0900c2e5cbc8ab$var$embedFont(fontFace) {
  ...
  if (typeof FileReader !== 'undefined')
    promise = $bc0900c2e5cbc8ab$var$fontToDataURLViaBlob(fontUrlMatch[1])
...
function $bc0900c2e5cbc8ab$var$embedGoogleFonts({
  fonts: fonts,
  text: text,
  styleNode: styleNode,
}) {
...
var $bc0900c2e5cbc8ab$export$2e2bcd8739ae039 =
  $bc0900c2e5cbc8ab$var$embedGoogleFonts
  ...
  container[emile] = function (el, style, opts) {
    ...
    interval = setInterval(function () {
      window.requestAnimationFrame(() => {
        ...
        } else opts.during && opts.during.apply(this, [(time - start) / dur])
      })
    }, 10)
  }
})('emile', window)
...
class $4e57e1a492ad5f5b$export$2e2bcd8739ae039 {
  constructor(slate) {
    ...
    if (typeof c === 'string')
      c = $8ab43d25a2892bde$export$2e2bcd8739ae039.el(c)
    ...
    $1b06af3f77ffbbd3$export$4ff7fc6f1af248b5(
      $65a92514e25c9f85$export$508faed300ccdfb
    )
    $934e6ef878cbebc0$export$cc3e2d3244e01b7f(
      $65a92514e25c9f85$export$508faed300ccdfb
    )
  ...
  init() {
    ...
    self.Canvas = {
      ...
      initDrag(e) {
        ...
        if (slate.options.allowDrag) {
          ...
          self.Canvas.objInitPos =
            $8ab43d25a2892bde$export$2e2bcd8739ae039.positionedOffset(
              self.internal
            )
          const offsets =
            $8ab43d25a2892bde$export$2e2bcd8739ae039.positionedOffset(
              slate.options.container
            )
    ...
    self.internal.style.cursor = `url(${imageFolder}openhand.cur), default`
    self.slate.paper = $65a92514e25c9f85$export$508faed300ccdfb(
      self.internal,
      _w,
      _h
    )
    ...
    if (
      ...
      if (!slate.options.isbirdsEye && slate.options.isSharing) {
        ...
        ;['download', 'embed'].forEach((e) => {
          ...
          const _new =
            $8ab43d25a2892bde$export$2e2bcd8739ae039.centerAndScalePathToFitContainer(
              {
          ...
          $8ab43d25a2892bde$export$2e2bcd8739ae039.addEvent(
            _btn,
            'click',
            () => {
              ...
              switch (_act) {
                case 'embed': {
                  ...
                  _note.setAttribute(
                    'style',
                    $8ab43d25a2892bde$export$2e2bcd8739ae039.buildStyle({
                      'font-size': '11pt',
                      'text-align': 'center',
                      padding: '4px',
                      'margin-right': '-1px',
  ...
  endDrag(coords) {
    ...
    const curPos = $8ab43d25a2892bde$export$2e2bcd8739ae039.positionedOffset(
      this.internal
    )
    const moved = {
  ...
  resize(val) {
    ...
    const dimen = $8ab43d25a2892bde$export$2e2bcd8739ae039.getDimensions(
      this.slate.options.container
    )
  ...
  rawSVG(cb) {
      ...
      if (images.length > 0)
        images.forEach((i, ind) => {
          if (self.slate.events.onBase64ImageRequested) {
            ...
            $8ab43d25a2892bde$export$2e2bcd8739ae039
              .toDataUrl(i)
              .then((dataUrl) => {
    ...
    $bc0900c2e5cbc8ab$export$2e2bcd8739ae039({
      fonts: $5OpyM$lodashuniq(
        self.slate.nodes.allNodes.map((n) => n.options.fontFamily)
      ),
      text: $5OpyM$lodashuniq(
...
class $d23f550fcae9c4c3$export$2e2bcd8739ae039 {
  ...
  registerPlugins(initPayload) {
    ...
    if ($d23f550fcae9c4c3$var$availablePlugins[root])
      $d23f550fcae9c4c3$var$availablePlugins[root].forEach((p) => {
...
class $f3f671e190122470$export$2e2bcd8739ae039 extends $d23f550fcae9c4c3$export$2e2bcd8739ae039 {
  constructor(options) {
    ...
    this.options = {
      ...
      parentArrowForChildren: [],
      noChildArrowForChildren: [],
      filters: {
        vect: null,
        text: null,
        line: null,
    ...
    if (json.relationships) {
      ...
      if (
        ...
        json.relationships.associations.forEach((association) => {
          ...
          let _pn = null
          self.slate.nodes.allNodes.forEach(
            ($f3f671e190122470$export$2e2bcd8739ae039) => {
              if (
                $f3f671e190122470$export$2e2bcd8739ae039.options.id ===
                  _pr.parentId &&
                self.options.id !==
                  $f3f671e190122470$export$2e2bcd8739ae039.options.id
              )
                _pn = $f3f671e190122470$export$2e2bcd8739ae039
            }
          )
          if (_pn) {
  ...
  getTempPathWithCorrectPositionFor({
    ...
    tempPath.transform('')
    const transformPath = $b3c679d5849c9a45$export$2e2bcd8739ae039(
  ...
  position(location, cb, easing, dur) {
    ...
    const d = $8ab43d25a2892bde$export$2e2bcd8739ae039.getDimensions(
      self.slate.options.container
    )
    const cw = d.width
    const ch = d.height
...
class $670a391adca558e5$export$2e2bcd8739ae039 {
  constructor(slate) {
    ...
    if (!$8ab43d25a2892bde$export$2e2bcd8739ae039.localRecipients)
      $8ab43d25a2892bde$export$2e2bcd8739ae039.localRecipients = []
    this.wire()
  }
  exe(pkg) {
    const self = this
  ...
  wire() {
    ...
    self.invoker = {
      ...
      onNodeResized(pkg) {
        ...
        Object.assign(
          cn.options,
          $5OpyM$lodashomit(pkg.data, ['associations', 'textPosition'])
        )
    ...
    if (self.pc.localizedOnly)
      $8ab43d25a2892bde$export$2e2bcd8739ae039.localRecipients.push(self)
  }
  _process(pkg) {
    const self = this
...
class $61e5ba2c77a639d8$export$2e2bcd8739ae039 {
  ...
  set(t, s, f, c, opacity, ta, tb) {
    ...
    if (c === this.node.options.backgroundColor)
      c = $8ab43d25a2892bde$export$2e2bcd8739ae039.whiteOrBlack(
        this.node.options.backgroundColor
      )
...
function $11c8f16cfca8adaf$export$2e2bcd8739ae039(opts = {}) {
  ...
  else if (ccy >= ((py2 - py4) / (px2 - px4)) * (ccx - px4) + py4)
    // means that child center point is above line 2
    relevantParentMiddlePoint = {
      x: px2,
      y: pcy,
  ...
  else if (pcy >= ((cy2 - cy4) / (cx2 - cx4)) * (pcx - cx4) + cy4)
    // means that child center point is above line 2
    relevantChildMiddlePoint = {
      x: cx2,
      y: ccy,
...
function $f7a6c59624db8286$export$2e2bcd8739ae039({
  ...
  relationships.forEach((r) => {
    ...
    if (nodes.some((n) => n.options.id === r.parent.options.id)) {
      ...
      const childPathContext = $3597cac994ae8502$export$2e2bcd8739ae039(
        tempEndNode || r.child.vect,
        midPoints.parent
      )
      const pointOnChildPath = childPathContext.bestPoint
      const parentPathContext = $3597cac994ae8502$export$2e2bcd8739ae039(
        tempOriginNode || r.parent.vect,
        pointOnChildPath
      )
      const pointOnParentPath = parentPathContext.bestPoint
      linePath = $e992036a92f1686f$export$2e2bcd8739ae039(
        pointOnParentPath,
        pointOnChildPath
      )
    } else {
...
class $f9b2caafbe71c9e4$export$2e2bcd8739ae039 {
  ...
  finishDrag(blnBroadcast) {
    ...
    self.selectedNodes.forEach((nd) => {
      ...
      $8ab43d25a2892bde$export$2e2bcd8739ae039.transformPath(
        nd,
        `T${self._dx},${self._dy}`
      )
      nd.vect.currentDx = 0
  ...
  enactMove(dx, dy, blnFinish) {
    ...
    self.selectedNodes.forEach((nd, i) => {
      ...
      if (i === 0 && nd.options.id !== self.slate.tempNodeId) {
        ...
        nearest.forEach((n) => {
          ;({ dx: dx, dy: dy } = self.node.gridLines.draw(
  ...
  _hitTest(mp) {
    const self = this
    let overNode = null
    const off = $8ab43d25a2892bde$export$2e2bcd8739ae039.positionedOffset(
      self.slate.options.container
    )
  ...
  _initDrag(vect, e) {
    ...
    if (self.slate.options.linking)
      ...
      self.kdTree = $5OpyM$statickdtree(
        self.foreignPoints.map((fp) => fp.point)
      )
  ...
  async initiateTempNode(e, _parent, _assocPkg) {
    ...
    const _path = $8ab43d25a2892bde$export$2e2bcd8739ae039._transformPath(
      $699224fae48c351a$export$2e2bcd8739ae039.icons.handle,
      `T${_xPos - 15}, ${_yPos - 15}`
    )
    ...
    _tempNode.vect.mousemove((ex) => {
      ...
      if (_tempRelationship.hoveredOver === null) {
        _tempRelationship.hoveredOver = self._hitTest(
          $8ab43d25a2892bde$export$2e2bcd8739ae039.mousePos(ex)
        )
        if (_tempRelationship.hoveredOver !== null)
  ...
  createNewRelationship(opts) {
    ...
    if (!association.line)
      Object.assign(association, {
        line: paper
          .path($e992036a92f1686f$export$2e2bcd8739ae039(origPoint, endPoint))
          .attr(_attr),
      })
...
class $b7b1bd055547e2ce$export$2e2bcd8739ae039 {
    ...
    self.rotateEvents = {
      ...
      move(dx, dy) {
        ...
        try {
          ...
          */ self.rotationAngle =
            $b7b1bd055547e2ce$export$2e2bcd8739ae039.getRotationAngle(
              {
                x: s.ox,
                y: s.oy,
              },
  ...
  show(x, y) {
    ...
    if (self.node.options.allowResize) {
      ...
      const rotatePathString =
        $8ab43d25a2892bde$export$2e2bcd8739ae039._transformPath(
...
class $e4a210c2d8385465$export$2e2bcd8739ae039 {
  ...
  show(x, y) {
    ...
    if (self.node.options.allowResize) {
      ...
      const resizePath =
        $8ab43d25a2892bde$export$2e2bcd8739ae039._transformPath(
          $699224fae48c351a$export$2e2bcd8739ae039.icons.resize,
          `t${x - 5},${y - 5} r95`
        )
  ...
  send() {
    ...
    const currentRotationPoint = $5OpyM$lodashclone(
      this.node.options.rotate.point
    )
    this.slate.birdsEye?.nodeChanged(pkg)
  ...
  set(width, height, opts = {}) {
    ...
    if (
      ...
      pathWithPotentialTransformations =
        $65a92514e25c9f85$export$508faed300ccdfb.transformPath(
          pathWithPotentialTransformations,
    ...
    const scaledVectPath = $65a92514e25c9f85$export$508faed300ccdfb
      .transformPath(self.node.vect.attr('path').toString(), scaleTransform)
      .toString()
    ...
    if (
      ...
      pathWithPotentialTransformations =
        $65a92514e25c9f85$export$508faed300ccdfb
          .transformPath(
            pathWithPotentialTransformations,
            `R${-self.node.options.rotate.rotationAngle}, ${
              self.origPoint.x
            }, ${self.origPoint.y}`
          )
          .toString()
...
class $5559a0452b57ea40$export$2e2bcd8739ae039 {
  ...
  async set(
    ...
    switch (pkg.shape) {
      case 'ellipse':
        _path = $8ab43d25a2892bde$export$2e2bcd8739ae039._transformPath(
...
class $d85238a851587679$export$2e2bcd8739ae039 {
  ...
  set(path, width, height, sendCollab) {
    ...
    if (width && height) {
      ...
      upath = $8ab43d25a2892bde$export$2e2bcd8739ae039._transformPath(
        path,
        ['s', scale, ',', scale].join('')
      )
    }
...
class $fc4b2653e376d71c$export$2e2bcd8739ae039 {
  ...
  setContext(e) {
    ...
    const all = $8ab43d25a2892bde$export$2e2bcd8739ae039.select(
      'div.contextMenuItem'
    )
...
class $8315835c374f6be2$export$2e2bcd8739ae039 {
  ...
  set(pkg) {
    ...
    if (pkg.val === 'toggle')
      a[pkg.prop] = a[pkg.prop] ? (pkg.prop, false) : true
  ...
  show(e, c) {
    ...
    const del = self.node.options.showRelationshipDelete
      ? r.trash().transform(transformToolbar(-45, 0)).attr({
          fill: '#fff',
          stroke: '#f00',
        })
      : null
...
class $9b98dd62c2bf15e9$export$2e2bcd8739ae039 {
  ...
  draw(
    ...
    self.guideAttrs.stroke =
      $8ab43d25a2892bde$export$2e2bcd8739ae039.whiteOrBlack(
        self.slate.options.containerStyle.backgroundColor
      )
...
class $20194a860b77746c$export$2e2bcd8739ae039 {
  ...
  removeRange(_nodes) {
    const self = this
    _nodes.forEach((node) => {
      self.allNodes = $20194a860b77746c$export$2e2bcd8739ae039.remove(
        self.allNodes,
        node
      )
    })
  ...
  remove(_node) {
    this.allNodes = $20194a860b77746c$export$2e2bcd8739ae039.remove(
      this.allNodes,
      _node
    )
    _node.slate = null
  ...
  saveRelationships(relationships, { dx: dx, dy: dy }) {
    relationships.forEach((r) => {
      const newLinePath = $8ab43d25a2892bde$export$2e2bcd8739ae039
  ...
  addToCanvas(_node, useMainCanvas) {
    ...
    switch (_node.options.vectorPath) {
      case 'ellipse':
        _node.options.vectorPath = $b3c679d5849c9a45$export$2e2bcd8739ae039(
    ...
    _node.editor = new $61e5ba2c77a639d8$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    ...
    // relationships
    _node.relationships = new $f9b2caafbe71c9e4$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    ...
    // rotate
    _node.rotate = new $b7b1bd055547e2ce$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // connectors
    _node.connectors = new $75d8b481b10b24dd$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // menu
    ...
    // resizer
    _node.resize = new $e4a210c2d8385465$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // images
    _node.images = new $5eeb98f61b0ae057$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // context
    _node.context = new $fc4b2653e376d71c$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // lineOptions
    _node.lineOptions = new $8315835c374f6be2$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // shapes
    _node.shapes = new $5559a0452b57ea40$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // customShapes
    _node.customShapes = new $d85238a851587679$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // colorPicker
    _node.colorPicker = new $237ec92496b6da7e$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
    // gridLines
    _node.gridLines = new $9b98dd62c2bf15e9$export$2e2bcd8739ae039(
      this.slate,
      _node
    )
...
class $2c56d294fa5e840e$export$2e2bcd8739ae039 {
  ...
  init() {
    ...
    function finalize() {
      ...
      $2c56d294fa5e840e$export$2e2bcd8739ae039.showConnections(
    ...
    if (c && self.slate.options.enabled && self.slate.options.showMultiSelect) {
      ...
      self.markerEvents = {
        init() {
          self.hideIcons()
          $2c56d294fa5e840e$export$2e2bcd8739ae039.hideConnections(
            self.relationshipsToTranslate.concat(self.relationshipsToRefresh)
          )
          self.moveX = 0
          self.moveY = 0
  ...
  showIcons() {
    const self = this
    if (self.marker !== null) {
      const groupIds = $5OpyM$lodashuniq(
        self.selectedNodes.map((n) => n.options.groupId)
      )
      ...
      copy.mousedown((e) => {
        ...
        self.selectedNodes.forEach((node) => {
          ...
          c.groupId = nGroupId
          c.id = $8ab43d25a2892bde$export$2e2bcd8739ae039
            .guid()
            .replace(/-/gi, '')
            .substring(0, 12)
        ...
        self.selectedNodes.forEach((node) => {
          ...
          node.relationships.associations
            ...
            .forEach((a) => {
              ...
              assocPkg.id = $8ab43d25a2892bde$export$2e2bcd8739ae039
                .guid()
                .replace(/-/gi, '')
                .substring(0, 12)
      ...
      if (!isGrouped) {
        ...
        group.mousedown((e) => {
          const groupId = $8ab43d25a2892bde$export$2e2bcd8739ae039
            .guid()
            .replace(/-/gi, '')
            .substring(0, 8)
            .toUpperCase()
  ...
  endSelection() {
    ...
    $8ab43d25a2892bde$export$2e2bcd8739ae039.removeEvent(
      self.slate.canvas.get(),
      'mousemove',
      self._move.bind(self)
    )
  ...
  _select(e) {
    ...
    if (sr) {
      ...
      // add any groupIds
      const groupIds = $5OpyM$lodashuniq(
        withinBox.map((n) => n.options.groupId)
      ).filter((g) => !!g)
...
class $9fd058e97992db72$export$2e2bcd8739ae039 {
  ...
  _wireHandle() {
    ...
    const init = function hnd() {
      ...
      start = $8ab43d25a2892bde$export$2e2bcd8739ae039.positionedOffset(
        self.slate.canvas.internal
      )
    }
    ...
    const up = () => {
      self.refresh()
      const end = $8ab43d25a2892bde$export$2e2bcd8739ae039.positionedOffset(
        self.slate.canvas.internal
      )
  ...
  show(_options) {
    ...
    $8ab43d25a2892bde$export$2e2bcd8739ae039.addEvent(window, 'resize', () => {
      ...
      self.parentDimen =
        $8ab43d25a2892bde$export$2e2bcd8739ae039.getDimensions(cx)
      self.setBe()
    })
  }
  enabled() {
  ...
  enable() {
    ...
    $8ab43d25a2892bde$export$2e2bcd8739ae039.el(
      `slatebirdsEye_${this.slate.options.id}`
    ).style.display = 'block'
  }
  disable() {
    $8ab43d25a2892bde$export$2e2bcd8739ae039.el(
  ...
  nodeChanged(pkg) {
    if (this.corner) {
      if (pkg.type === 'onNodesMove')
        this.corner.nodes.moveNodes(pkg, {
          useMainCanvas: true,
        })
      else {
            ...
            case 'onNodeRotated': {
              pkg.data.associations.forEach((association) => {
                ...
                if (currentAssociation)
                  currentAssociation.line.attr({
                    path: association.linePath,
                  })
              })
              Object.assign(
                _node.options,
                $5OpyM$lodashomit(pkg.data, 'associations')
              )
  ...
  refresh(blnNoAdditions) {
    if (this.corner) {
      ...
      this.parentDimen =
        $8ab43d25a2892bde$export$2e2bcd8739ae039.getDimensions(c)
      this.handle?.remove()
...
class $19a04256932b9422$export$2e2bcd8739ae039 {
  constructor(slate) {
    ...
    self.slate = slate
    self.slider = null
    self.sliderId = `sb-zoom-slider-${$8ab43d25a2892bde$export$2e2bcd8739ae039
      .guid()
      .substring(8)}`
  }
  setValue(val) {
  ...
  hide() {
    if (
      $8ab43d25a2892bde$export$2e2bcd8739ae039.el(
        `slateSlider_${this.slate.options.id}`
      ) !== null
    )
...
class $7605cf3068a61b3e$export$2e2bcd8739ae039 {
  ...
  hide() {
    if ($8ab43d25a2892bde$export$2e2bcd8739ae039.el('slateUndoRedo') !== null)
      try {
        this.slate.options.container.removeChild(
          $8ab43d25a2892bde$export$2e2bcd8739ae039.el('slateUndoRedo')
        )
      } catch (err) {}
  }
  show(_options) {
    ...
    options.paper = $65a92514e25c9f85$export$508faed300ccdfb(
      'slateUndoRedo',
      options.width,
      options.height
    )
  ...
  engage() {
    ...
    if (!self.engaged) {
      ...
      svg.addEventListener('mousedown', (e) => {
        ...
        const tpath = $8ab43d25a2892bde$export$2e2bcd8739ae039._transformPath(
          comment,
          `T${x},${y}s2,2`
        )
        ...
        const commentNode = new $f3f671e190122470$export$2e2bcd8739ae039(
          commentNodeOpts
        )
...
class $5e710bc15c419cd8$export$2e2bcd8739ae039 {
  ...
  add(filter, isDefault) {
    ...
    const filterDef = {
      id:
        filter.id ||
        $8ab43d25a2892bde$export$2e2bcd8739ae039.guid().substring(10),
      tag: 'filter',
...
class $52815ef246a0a8c3$export$2e2bcd8739ae039 extends $d23f550fcae9c4c3$export$2e2bcd8739ae039 {
  constructor(_options, events, collaboration) {
    ...
    this.options = {
      ...
      containerStyle: {
        ...
        backgroundSize: '',
        backgroundEffect: '',
        backgroundColorAsGradient: false,
    ...
    if (
      !$8ab43d25a2892bde$export$2e2bcd8739ae039.isElement(
        this.options.container
      )
    )
      this.options.container = $8ab43d25a2892bde$export$2e2bcd8739ae039.el(
        this.options.container
      )
    this.constants = {
      statusPanelAtRest: 33,
  ...
  copy(opts) {
    const self = this
    if (!self.copySlate)
      self.copySlate = new $52815ef246a0a8c3$export$2e2bcd8739ae039({
    ...
    _json.nodes.forEach((nde) => {
      ...
      if (_mpkg) {
        ...
        nde.options.vectorPath = $b3c679d5849c9a45$export$2e2bcd8739ae039(
          $f3f671e190122470$export$2e2bcd8739ae039.options.vectorPath,
          _transforms
        )
      }
    })
  ...
  svg(opts, cb) {
    ...
    const _exportCanvas = new $52815ef246a0a8c3$export$2e2bcd8739ae039(
      exportOptions
    ).init()
  ...
  loadJSON(_jsonSlate, blnPreserve, blnSkipZoom, useMainCanvas = false) {
    ...
    self.loadAllFonts()
    if (!blnSkipZoom)
      self.controller.centerOnNodes({
        dur: 0,
      })
  }
  loadAllFonts() {
    // load all fonts
    const fonts = $5OpyM$lodashuniq(
