...
/* eslint-disable import/prefer-default-export */ /* eslint-disable import/no-cycle */ /* eslint-disable no-template-curly-in-string */ /* eslint-disable class-methods-use-this */ /* eslint-disable no-param-reassign */ /* eslint-disable no-underscore-dangle */ /* eslint-disable no-unused-expressions */ /* eslint-disable new-cap */ /* eslint-disable import/no-cycle */ 


/* eslint-disable no-underscore-dangle */ /* eslint-disable no-param-reassign */ /* eslint-disable no-return-assign */ /* eslint-disable */ // Copyright (c) 2017 Adobe Systems Incorporated. All rights reserved.
//
...
const $c453c098b23bc46d$export$db202ddc8be9136 = function() {
  ...
  \ */ R.matrix = function(a, b, c, d, e, f) {
    ...
    var dragUp = function(e) {
        ...
        while(i--){
            dragi = drag[i];
            dragi.el._drag = {};
            (0, $dacea6f50a09eb13$export$6b962911844bfb1e)(`raphael.drag.end.${dragi.el.id}`, dragi.end_scope || dragi.start_scope || dragi.move_scope || dragi.el, e);
        }
        drag = [];
    };
    /* \
  ...
  \ */ elproto.data = function(key, value) {
        ...
        if (arguments.length == 1) {
            ...
            (0, $dacea6f50a09eb13$export$6b962911844bfb1e)(`raphael.data.get.${this.id}`, this, data[key], key);
            return data[key];
        }
        data[key] = value;
        (0, $dacea6f50a09eb13$export$6b962911844bfb1e)(`raphael.data.set.${this.id}`, this, value, key);
        return this;
    };
    /* \
   * Element.removeData
  ...
  \ */ elproto.drag = function(onmove, onstart, onend, move_scope, start_scope, end_scope) {
        function start(e) {
            ...
            onstart && (0, $dacea6f50a09eb13$export$6b962911844bfb1e).on(`raphael.drag.start.${this.id}`, onstart);
            onmove && (0, $dacea6f50a09eb13$export$6b962911844bfb1e).on(`raphael.drag.move.${this.id}`, onmove);
  ...
  \ */ elproto.onDragOver = function(f) {
        f ? (0, $dacea6f50a09eb13$export$6b962911844bfb1e).on(`raphael.drag.over.${this.id}`, f) : (0, $dacea6f50a09eb13$export$6b962911844bfb1e).unbind(`raphael.drag.over.${this.id}`);
    };
    /* \
   * Element.undrag
   [ method ]
  ...
  \ */ elproto.undrag = function() {
        ...
        while(i--)if (draggable[i].el == this) {
            ...
            (0, $dacea6f50a09eb13$export$6b962911844bfb1e).unbind(`raphael.drag.*.${this.id}`);
        }
        ...
        for(; l < animationElements.length; l++){
            ...
            if (time < ms) {
                ...
                (function(id, that, anim) {
                    setTimeout(()=>{
                        (0, $dacea6f50a09eb13$export$6b962911844bfb1e)(`raphael.anim.frame.${id}`, that, anim);
                    });
                })(that.id, that, e.anim);
            } else {
                (function(f, el, a) {
  ...
  \ */ elproto.animateWith = function(el, anim, params, ms, easing, callback) {
    ...
    elproto.onAnimation = function(f) {
        f ? (0, $dacea6f50a09eb13$export$6b962911844bfb1e).on(`raphael.anim.frame.${this.id}`, f) : (0, $dacea6f50a09eb13$export$6b962911844bfb1e).unbind(`raphael.anim.frame.${this.id}`);
        return this;
    };
  ...
  \ */ Animation.prototype.repeat = function(times) {
    ...
    function runAnimation(anim, element, percent, status, totalOrigin, times) {
        ...
        (0, $dacea6f50a09eb13$export$6b962911844bfb1e)(`raphael.anim.start.${element.id}`, element, anim);
    }
    /* \
   * Raphael.animation
   [ method ]
  ...
  \ */ elproto.pause = function(anim) {
        for(let i = 0; i < animationElements.length; i++)if (animationElements[i].el.id == this.id && (!anim || animationElements[i].anim == anim)) {
            if ((0, $dacea6f50a09eb13$export$6b962911844bfb1e)(`raphael.anim.pause.${this.id}`, this, animationElements[i].anim) !== false) animationElements[i].paused = true;
        }
        return this;
    };
    /* \
  ...
  \ */ elproto.resume = function(anim) {
        for(let i = 0; i < animationElements.length; i++)if (animationElements[i].el.id == this.id && (!anim || animationElements[i].anim == anim)) {
            ...
            if ((0, $dacea6f50a09eb13$export$6b962911844bfb1e)(`raphael.anim.resume.${this.id}`, this, e.anim) !== false) {
                delete e.paused;
  ...
  \ */ elproto.stop = function(anim) {
        for(let i = 0; i < animationElements.length; i++)if (animationElements[i].el.id == this.id && (!anim || animationElements[i].anim == anim)) {
            if ((0, $dacea6f50a09eb13$export$6b962911844bfb1e)(`raphael.anim.stop.${this.id}`, this, animationElements[i].anim) !== false) animationElements.splice(i--, 1);
        }
        return this;
    };
...
const $65a92514e25c9f85$export$508faed300ccdfb = function() {
        ...
        if (!el) {
            ...
            if (type == "linear") {
                ...
                var vector = [
                    0,
                    0,
                    math.cos((0, $c453c098b23bc46d$export$db202ddc8be9136).rad(angle)),
                    math.sin((0, $c453c098b23bc46d$export$db202ddc8be9136).rad(angle))
                ];
        ...
        if (o.type == "path") {
            ...
            if (type != "none") {
                ...
                if (isEnd) {
                    ...
                    from = delta * stroke;
                    to = (0, $c453c098b23bc46d$export$db202ddc8be9136).getTotalLength(attrs.path) - (o._.arrows.enddx * stroke || 0);
                }
                attr = {};
                attr[`marker-${se}`] = `url(#${markerId})`;
                if (to || from) attr.d = (0, $c453c098b23bc46d$export$db202ddc8be9136).getSubpath(attrs.path, from, to);
                $(node, attr);
                ...
                if (isEnd) {
                    from = o._.arrows.startdx * stroke || 0;
                    to = (0, $c453c098b23bc46d$export$db202ddc8be9136).getTotalLength(attrs.path) - from;
                } else {
                    from = 0;
                    to = (0, $c453c098b23bc46d$export$db202ddc8be9136).getTotalLength(attrs.path) - (o._.arrows.enddx * stroke || 0);
                }
                o._.arrows[`${se}Path`] && $(node, {
                    d: (0, $c453c098b23bc46d$export$db202ddc8be9136).getSubpath(attrs.path, from, to)
                });
            ...
            for(attr in markerCounter)if (markerCounter[has](attr) && !markerCounter[attr]) {
                const item = (0, $c453c098b23bc46d$export$db202ddc8be9136)._g.doc.getElementById(attr);
        ...
        for(let att in params)if (params[has](att)) {
            ...
            switch(att){
                ...
                case "fill":
                    ...
                    var clr = (0, $c453c098b23bc46d$export$db202ddc8be9136).getRGB(value);
                    if (!clr.error) {
    ...
    var tuneText = function(el, params) {
        ...
        if (params[has]("text")) {
            ...
            for(var i = 0, ii = texts.length; i < ii; i++){
                ...
                tspan.appendChild((0, $c453c098b23bc46d$export$db202ddc8be9136)._g.doc.createTextNode(texts[i]));
     ...
     */ function guid() {
        ...
        this.matrix = (0, $c453c098b23bc46d$export$db202ddc8be9136).matrix();
        this.realPath = null;
        /* \
       * Element.paper
       [ property (object) ]
    ...
    const elproto = (0, $c453c098b23bc46d$export$db202ddc8be9136).el;
  ...
  \ */ elproto.transform = function(tstr) {
        ...
        (0, $c453c098b23bc46d$export$db202ddc8be9136)._extractTransform(this, tstr);
        this.clip && $(this.clip, {
  ...
  \ */ elproto.remove = function() {
        ...
        (0, $dacea6f50a09eb13$export$6b962911844bfb1e).unbind(`raphael.*.*.${this.id}`);
        if (this.gradient) paper.defs.removeChild(this.gradient);
        (0, $c453c098b23bc46d$export$db202ddc8be9136)._tear(this, paper);
  ...
  \ */ elproto.toFront = function() {
        ...
        svg.top != this && (0, $c453c098b23bc46d$export$db202ddc8be9136)._tofront(this, svg);
        return this;
    };
    /* \
   * Element.toBack
  ...
  \ */ elproto.toBack = function() {
        ...
        (0, $c453c098b23bc46d$export$db202ddc8be9136)._toback(this, this.paper);
        const svg = this.paper;
        return this;
    };
    /* \
  ...
  \ */ elproto.insertAfter = function(element) {
        ...
        (0, $c453c098b23bc46d$export$db202ddc8be9136)._insertafter(this, element, this.paper);
        return this;
    };
    /* \
  ...
  \ */ elproto.insertBefore = function(element) {
        ...
        (0, $c453c098b23bc46d$export$db202ddc8be9136)._insertbefore(this, element, this.paper);
        return this;
    };
    ...
    (0, $c453c098b23bc46d$export$db202ddc8be9136)._engine.g = function(svg) {
        ...
        elements.forEach((element)=>{
            res[element] = function() {
                ...
                const out = (0, $c453c098b23bc46d$export$db202ddc8be9136)._engine[element].apply(this, args);
                return out;
            };
        });
        $(el, res.attrs);
    ...
    */ const id = def.id || `raphael-def-${(0, $c453c098b23bc46d$export$db202ddc8be9136).createUUID()}`;
    ...
    (0, $c453c098b23bc46d$export$db202ddc8be9136)._engine.create = function() {
        ...
        if (container == 1) {
            ...
            (0, $c453c098b23bc46d$export$db202ddc8be9136)._g.doc.body.appendChild(cnvs);
            isFloating = 1;
        } else {
        ...
        container = new (0, $c453c098b23bc46d$export$db202ddc8be9136)._Paper();
  ...
  \ */ (0, $c453c098b23bc46d$export$db202ddc8be9136).prototype.renderfix = function() {
  ...
  \ */ (0, $c453c098b23bc46d$export$db202ddc8be9136).prototype.remove = function() {
    ...
    return 0, $c453c098b23bc46d$export$db202ddc8be9136;
}();
...
function $b3c679d5849c9a45$export$2e2bcd8739ae039(originalPath, transforms) {
    ...
    transformsArray.forEach((transform)=>{
        transformedPath = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039)._transformPath(transformedPath, transform).toString();
    });
...
/* eslint-disable */ const $934e6ef878cbebc0$export$cc3e2d3244e01b7f = function(R) {
...
class $4e57e1a492ad5f5b$export$2e2bcd8739ae039 {
    ...
    init() {
        ...
        self.Canvas = {
            ...
            initDrag (e) {
                ...
                if (slate.options.allowDrag) {
                    ...
                    const m = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).mousePos(e);
                    self.Canvas.objInitPos = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).positionedOffset(self.internal);
                    const offsets = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).positionedOffset(slate.options.container);
                ...
                else (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).stopEvent(e);
            },
            setCursor () {
            ...
            onDrag (e) {
                requestAnimationFrame(()=>{
                    ...
                    const curPos = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).positionedOffset(self.internal);
        ...
        self.internal.style.cursor = `url(${imageFolder}openhand.cur), default`;
        self.slate.paper = (0, $65a92514e25c9f85$export$508faed300ccdfb)(self.internal, _w, _h);
            ...
            if (!slate.options.isbirdsEye && slate.options.isSharing) {
                ...
                [
                    ...
                    const _new = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).centerAndScalePathToFitContainer({
                        ...
                        path: (0, $699224fae48c351a$export$2e2bcd8739ae039).icons[e]
                    });
    ...
    endDrag(coords) {
        ...
        const curPos = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).positionedOffset(this.internal);
        const moved = {
    ...
    zoom(_opts) {
        ...
        emile(self.internal, "padding:1px", {
            ...
            easing: (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).easing[opts.easing]
        });
    }
    move(_opts) {
        const self = this;
    ...
    bbox() {
        const dimen = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).getDimensions(this.slate.options.container);
        return {
    ...
    rawSVG(cb) {
        ...
        function extractImages(__svg) {
            let ssvg = __svg;
            const images = (0, $5OpyM$lodashuniq)(self.slate.nodes.allNodes.map((n)=>n.options.image).filter((f)=>!!f));
        ...
        if (e) {
            if (!self.slate.options.isbirdsEye) {
                ...
                self.showBgTimeout = setTimeout(()=>{
                    if (!(0, $8ab43d25a2892bde$export$2e2bcd8739ae039).isSafari()) {
                        const attrs = {
                            filter: `url(#${e})`
                        };
                        if (!(0, $8ab43d25a2892bde$export$2e2bcd8739ae039).isSafari() && !(0, $8ab43d25a2892bde$export$2e2bcd8739ae039).isMobile() && self.slate.filters.availableFilters[e]?.fill) attrs.fill = `url(#${self.slate.filters.availableFilters[e]?.fill})`;
...
class $f3f671e190122470$export$2e2bcd8739ae039 extends (0, $d23f550fcae9c4c3$export$2e2bcd8739ae039) {
    constructor(options){
        super();
        this._lock = null;
        this._openLock = null;
    ...
    */ // UNTIL PAN AND ZOOM WORKS CORRECTLY, THIS WILL
    ...
    position(location, cb, easing, dur) {
        ...
        const d = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).getDimensions(self.slate.options.container);
        const cw = d.width;
        const ch = d.height;
...
class $670a391adca558e5$export$2e2bcd8739ae039 {
    ...
    _process(pkg) {
        const self = this;
        if ((0, $8ab43d25a2892bde$export$2e2bcd8739ae039).localRecipients.length > 1) {
            let _time = 0;
            (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).localRecipients.forEach((s)=>{
                _time += 10;
                ((rec, t)=>{
                    setTimeout(()=>{
...
/* eslint-disable new-cap */ /* eslint-disable class-methods-use-this */ /* eslint-disable no-param-reassign */ /* eslint-disable no-underscore-dangle */ 
...
/* eslint-disable no-lonely-if */ function $11c8f16cfca8adaf$export$2e2bcd8739ae039(opts = {}) {
...
function $f7a6c59624db8286$export$2e2bcd8739ae039({ relationships: relationships, nodes: nodes, dx: dx = 0, dy: dy = 0 }) {
    relationships.forEach((r)=>{
        const midPoints = (0, $11c8f16cfca8adaf$export$2e2bcd8739ae039)(r);
        let tempOriginNode;
        let tempEndNode;
        let linePath;
        if (nodes.some((n)=>n.options.id === r.parent.options.id)) {
            ...
            const childPathContext = (0, $3597cac994ae8502$export$2e2bcd8739ae039)(tempEndNode || r.child.vect, midPoints.parent);
...
class $f9b2caafbe71c9e4$export$2e2bcd8739ae039 {
    ...
    _initDrag(vect, e) {
        ...
        if (self.slate.options.linking) self.slate.options.linking.onNode.apply(vect, [
            ...
            self.kdTree = (0, $5OpyM$statickdtree)(self.foreignPoints.map((fp)=>fp.point));
    ...
    async initiateTempNode(e, _parent, _assocPkg) {
        ...
        const off = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).positionedOffset(_slate.options.container);
        const _zr = self.slate.options.viewPort.zoom.r;
        ...
        const _path = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039)._transformPath((0, $699224fae48c351a$export$2e2bcd8739ae039).icons.handle, `T${_xPos - 15}, ${_yPos - 15}`);
        const _tempNode = new (0, $f3f671e190122470$export$2e2bcd8739ae039)({
        ...
        _tempNode.vect.mouseup((ex)=>{
            ...
            const overNode = self._hitTest((0, $8ab43d25a2892bde$export$2e2bcd8739ae039).mousePos(ex));
            if (overNode !== null) {
...
/* eslint-disable no-use-before-define */ /* eslint-disable no-underscore-dangle */ 
...
/* eslint-disable new-cap */ /* eslint-disable no-underscore-dangle */ 
...
class $75d8b481b10b24dd$export$2e2bcd8739ae039 {
    ...
    createNode(skipCenter, options, targetXPos, targetYPos, doBroadcast) {
        const self = this;
        const newNode = new (0, $f3f671e190122470$export$2e2bcd8739ae039)(options);
        self.slate.nodes.add(newNode);
        (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).transformPath(newNode, `T${targetXPos - newNode.options.xPos}, ${targetYPos - newNode.options.yPos}`);
    ...
    addNode(skipCenter) {
        ...
        const newId = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).guid();
...
/* eslint-disable no-use-before-define */ /* eslint-disable no-param-reassign */ /* eslint-disable no-underscore-dangle */ 
...
class $e4a210c2d8385465$export$2e2bcd8739ae039 {
    ...
    send() {
        ...
        const currentRotationPoint = (0, $5OpyM$lodashclone)(this.node.options.rotate.point);
        this.slate.birdsEye?.nodeChanged(pkg);
        this.node.options.rotate.point = currentRotationPoint;
        this.slate.collab?.send(pkg);
    }
    lazySend() {
        (0, $5OpyM$lodashthrottle)(this.send, 700);
    }
    animateSet(data, opts) {
        const self = this;
    ...
    set(width, height, opts = {}) {
        ...
        if (self.origPoint && Object.entries(self.origPoint).length > 0 && self.node.options.rotate.rotationAngle > 0) pathWithPotentialTransformations = (0, $65a92514e25c9f85$export$508faed300ccdfb).transformPath(pathWithPotentialTransformations, `R${-self.node.options.rotate.rotationAngle}, ${self.origPoint.x}, ${self.origPoint.y}`).toString();
        self.node.vect.attr({
            path: pathWithPotentialTransformations
        });
    ...
    async set(pkg = {
        ...
        switch(pkg.shape){
            ...
            case "rect":
                ...
                break;
            default:
                _path = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039)._transformPath(pkg.shape, `T${this.node.options.xPos},${this.node.options.yPos}`);
                this.node.options.isEllipse = false;
                break;
        }
...
class $fc4b2653e376d71c$export$2e2bcd8739ae039 {
    ...
    ctx(e) {
        ...
        return (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).stopEvent(e);
    }
    create() {
...
class $9b98dd62c2bf15e9$export$2e2bcd8739ae039 {
    ...
    draw(id, dx, dy, bb, translateNode = true, guideVisibleAt = 100, guideSnapAt = 20) {
        ...
        self.guideAttrs.stroke = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).whiteOrBlack(self.slate.options.containerStyle.backgroundColor);
...
class $20194a860b77746c$export$2e2bcd8739ae039 {
    ...
    */ const orient = self.slate.getOrientation(null, true) // - always pin to no zoom (1)
    ...
    nodeMovePackage(opts = {}) {
        ...
        const _ret = {
            ...
            associations: (()=>{
                ...
                return (0, $5OpyM$lodashuniq)(assoc, (a)=>a.id);
            })()
        };
    ...
    moveNodes(pkg, options = {}) {
        ...
        nodeOptions.forEach((opts)=>{
            ...
            if (nodeObject) {
                ...
                const dps = (0, $a26df7539d136ffa$export$2e2bcd8739ae039)({
                    x: opts.xPos,
                    y: opts.yPos
                }, nodeObject.options);
    ...
    addToCanvas(_node, useMainCanvas) {
        ...
        // relationships
        _node.relationships = new (0, $f9b2caafbe71c9e4$export$2e2bcd8739ae039)(this.slate, _node);
        _node.relationships.wireDragEvents();
        // rotate
        _node.rotate = new (0, $b7b1bd055547e2ce$export$2e2bcd8739ae039)(this.slate, _node);
        // connectors
        _node.connectors = new (0, $75d8b481b10b24dd$export$2e2bcd8739ae039)(this.slate, _node);
        // menu
        _node.menu = new (0, $4026fc4adb3b1376$export$2e2bcd8739ae039)(this.slate, _node);
        // resizer
        _node.resize = new (0, $e4a210c2d8385465$export$2e2bcd8739ae039)(this.slate, _node);
        // images
        _node.images = new (0, $5eeb98f61b0ae057$export$2e2bcd8739ae039)(this.slate, _node);
        // context
        _node.context = new (0, $fc4b2653e376d71c$export$2e2bcd8739ae039)(this.slate, _node);
        // lineOptions
        _node.lineOptions = new (0, $8315835c374f6be2$export$2e2bcd8739ae039)(this.slate, _node);
        // shapes
        _node.shapes = new (0, $5559a0452b57ea40$export$2e2bcd8739ae039)(this.slate, _node);
        // customShapes
        _node.customShapes = new (0, $d85238a851587679$export$2e2bcd8739ae039)(this.slate, _node);
        // colorPicker
        _node.colorPicker = new (0, $237ec92496b6da7e$export$2e2bcd8739ae039)(this.slate, _node);
        // gridLines
        _node.gridLines = new (0, $9b98dd62c2bf15e9$export$2e2bcd8739ae039)(this.slate, _node);
        //links
...
class $2c56d294fa5e840e$export$2e2bcd8739ae039 {
    ...
    init() {
        ...
        function finalize() {
            ...
            self.selectedNodes.forEach((node)=>{
                (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).transformPath(node, `T${self.moveX},${self.moveY}`);
    ...
    createCopiedNodes(nodeOptions, assocDetails) {
        ...
        nodeOptions.forEach((n)=>{
            const nn = new (0, $cf838c15c8b009ba$export$6cc593952597f80d).node(n);
    ...
    showIcons() {
        const self = this;
        if (self.marker !== null) {
            const groupIds = (0, $5OpyM$lodashuniq)(self.selectedNodes.map((n)=>n.options.groupId));
            ...
            copy.mousedown((e)=>{
                ...
                self.selectedNodes.forEach((node)=>{
                    ...
                    nodeOptions.push(c);
                    const nn = new (0, $cf838c15c8b009ba$export$6cc593952597f80d).node(c);
                    self.slate.nodes.add(nn);
                });
    ...
    _select() {
        ...
        if (sr) {
            ...
            // add any groupIds
            const groupIds = (0, $5OpyM$lodashuniq)(withinBox.map((n)=>n.options.groupId)).filter((g)=>!!g);
...
class $9fd058e97992db72$export$2e2bcd8739ae039 {
    ...
    _wireHandle() {
        ...
        const up = ()=>{
            self.refresh();
            const end = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).positionedOffset(self.slate.canvas.internal);
    ...
    refresh(blnNoAdditions) {
        if (this.corner) {
            ...
            this.parentDimen = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).getDimensions(c);
            this.handle?.remove();
...
class $a8686d78200754a9$export$2e2bcd8739ae039 {
    ...
    center(_opts) {
        ...
        Object.assign(opts, _opts);
        const ws = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).windowSize();
...
class $19a04256932b9422$export$2e2bcd8739ae039 {
    constructor(slate){
        ...
        self.slate = slate;
        self.slider = null;
        self.sliderId = `sb-zoom-slider-${(0, $8ab43d25a2892bde$export$2e2bcd8739ae039).guid().substring(8)}`;
    }
    setValue(val) {
...
class $95f7fca09bb5481b$export$2e2bcd8739ae039 {
    ...
    setGrid() {
        ...
        const gridColor = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).whiteOrBlack(gbg);
    ...
    engage() {
        ...
        if (!self.engaged) {
            ...
            svg.addEventListener("mousedown", (e)=>{
                ...
                const tpath = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039)._transformPath(comment, `T${x},${y}s2,2`);
                const pbox = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).getBBox({
                    path: tpath
                });
                ...
                const commentNode = new (0, $f3f671e190122470$export$2e2bcd8739ae039)(commentNodeOpts);
...
class $07361c58e711f582$export$2e2bcd8739ae039 {
    ...
    key(e, blnKeyDown) {
        ...
        const key = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).getKey(e);
        switch(key){
            case 91:
            case 17:
...
class $5e710bc15c419cd8$export$2e2bcd8739ae039 {
    ...
    addDeps(deps) {
        ...
        deps.forEach((d)=>{
            const depDef = {
                id: (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).guid().substring(10),
                tag: d.type,
                ...d.attrs,
                inside: []
            };
...
class $52815ef246a0a8c3$export$2e2bcd8739ae039 extends (0, $d23f550fcae9c4c3$export$2e2bcd8739ae039) {
    constructor(_options, events){
        ...
        if (!(0, $8ab43d25a2892bde$export$2e2bcd8739ae039).isElement(this.options.container)) this.options.container = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).el(this.options.container);
        this.constants = {
            statusPanelAtRest: 33,
            statusPanelExpanded: 200
        };
        this.glows = [];
        this.tips = [];
        this.tempNodeId = (0, $8ab43d25a2892bde$export$2e2bcd8739ae039).guid();
        this.allLines = [];
    ...
    prep() {
        ...
        self.nodes = new (0, $20194a860b77746c$export$2e2bcd8739ae039)(self);
        self.collab = new (0, $670a391adca558e5$export$2e2bcd8739ae039)(self);
        self.birdsEye = new (0, $9fd058e97992db72$export$2e2bcd8739ae039)(self);
        self.zoomSlider = new (0, $19a04256932b9422$export$2e2bcd8739ae039)(self);
        if (!self.isReadOnly() && !self.isCommentOnly()) {
            self.undoRedo = new (0, $7605cf3068a61b3e$export$2e2bcd8739ae039)(self);
            self.multiSelection = new (0, $2c56d294fa5e840e$export$2e2bcd8739ae039)(self);
        }
        self.controller = new (0, $a8686d78200754a9$export$2e2bcd8739ae039)(self);
    ...
    copy(opts) {
        ...
        _json.nodes.forEach((nde)=>{
            ...
            if (_mpkg) {
                ...
                nde.options.vectorPath = (0, $b3c679d5849c9a45$export$2e2bcd8739ae039)(nde.options.vectorPath, _transforms);
            }
        });
