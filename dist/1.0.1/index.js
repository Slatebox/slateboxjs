...
class $4e57e1a492ad5f5b$export$2e2bcd8739ae039 {
    ...
    init() {
        ...
        self.internal.setAttribute('class', `slateboxInternal_${self.slate.options.id}`);
    ...
    wire() {
        ...
        self.invoker = {
            ...
            onSlateThemeChanged (pkg) {
                ...
                if (pkg.data?.theme) self.slate.applyTheme(pkg.data.theme, pkg.data.syncWithTheme, pkg.data.revertTheme);
            },
...
class $20194a860b77746c$export$2e2bcd8739ae039 {
    ...
    remove(_node) {
        this.allNodes = $20194a860b77746c$export$2e2bcd8739ae039.remove(this.allNodes, _node);
        _node.slate = null;
...
class $9fd058e97992db72$export$2e2bcd8739ae039 {
    ...
    enable() {
        ...
        $8ab43d25a2892bde$export$2e2bcd8739ae039.el(`slatebirdsEye_${this.slate.options.id}`).style.display = 'block';
    }
    disable() {
        $8ab43d25a2892bde$export$2e2bcd8739ae039.el(`slatebirdsEye_${this.slate.options.id}`).style.display = 'none';
    }
...
class $19a04256932b9422$export$2e2bcd8739ae039 {
    ...
    hide() {
        if ($8ab43d25a2892bde$export$2e2bcd8739ae039.el(`slateSlider_${this.slate.options.id}`) !== null) this.slate.options.container.removeChild($8ab43d25a2892bde$export$2e2bcd8739ae039.el(`slateSlider_${this.slate.options.id}`));
    }
    show(_options) {
        const self = this;
